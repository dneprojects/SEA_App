...
- **Neuer Modus „Automatisch — SEA adaptiert".** SEA prüft stündlich, ob eine andere Einstellung dein Ziel besser erreicht — und stellt sie selbst um. Mit Bremsen: nur wenn es sich lohnt (ab 10 Cent am Tag), höchstens alle vier Stunden, und nur was SEA wirklich einstellen kann. Jede Anpassung erscheint mit Uhrzeit und Begründung unter *Heute → Hinweise* und wird angesagt; rückgängig über „Alternativen prüfen".
...
- **Ziel und Autonomie stehen in der Kartenüberschrift** („Kosten · Automatisch") und auf *Heute* neben dem Plan — man sieht ohne Aufklappen, wonach SEA fährt. Die drei Karten unter *Verhalten* starten zugeklappt.
