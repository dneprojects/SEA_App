...
- **Hinweise lassen sich wegklicken** (× oben rechts). Ein weggeklickter Hinweis bleibt weg, solange die Lage besteht — klärt sie sich und tritt später wieder auf, meldet er sich erneut.
...
- **Das Fahrzeug hängt im Flussdiagramm unter seiner Wallbox** — mit Namen und Ladezustand, so wie die Batterie ihren SoC trägt.
