...
- **Die Ausblick-Grafik ist am Desktop jetzt zeitlich gestreckt und horizontal scrollbar** — per Pfeil-Buttons am Rand (ein Klick = 25 %), Ziehen der Leiste oder Umschalt+Mausrad; das normale (senkrechte) Mausrad scrollt weiter die Seite. Die Streckung wirkt nur waagerecht, die Höhe/Y-Achse bleiben unverändert.
