...
- **Der Tarifvergleich passt jetzt zu den Ist-Kosten und zeigt immer alle Tarifmodelle** — statt einer Re-Simulation (die auf der reinen Grundlast rechnete und zu niedrige Kosten zeigte) wird jetzt der **tatsächlich aufgezeichnete Netzbezug** unter jedem Tarifmodell neu bewertet: „Fest" entspricht damit deinen Ist-Kosten, und HT/NT sowie „Dynamisch" werden **immer** als Vergleich angeboten (auch ohne eigenen HT/NT- oder dynamischen Vertrag). HT/NT und dynamisch nutzen deinen Speicher zur Arbitrage (laden wenn günstig, entladen wenn teuer), dynamisch verschiebt zusätzlich verschiebbare Geräte ins günstigste Tagesfenster; ohne echte Börsen-Historie dient ein Tag/Nacht/Spitzen-Modell als Näherung. Modelliert mit deiner echten Batterieleistung.
